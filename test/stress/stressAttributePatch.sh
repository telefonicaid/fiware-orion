...
echo "2.3. Creating the payload body file for PATCH a single attribute for Apache benchmarking tool in step 7"
echo "========================================================================================"
echo '{'                                  > /tmp/body.json
echo '"value": 14'                       >> /tmp/body.json
echo "}"                                 >> /tmp/body.json


echo "13. Running Apache HTTP server benchmarking tool (ab) with $threads threads and a total of $requests requests PATCHing an attribute"
echo "==================================================================================================================================="
ab -c $threads -d -n $requests -T application/json -p /tmp/body.json -m PATCH http://localhost:1026/ngsi-ld/v1/entities/urn:ngsi-ld:entities:E1/attrs/P1
r=$?
echo
echo
