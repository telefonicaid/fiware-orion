...
echo "2.2. Asking the broker how many entities it has - should be $entities!!!"
echo "=================================================================="
...
echo "2.3. Creating the payload body file for Apache benchmarking tool in step 2.4"
echo "============================================================================"
echo "[" > /tmp/body.json
eNo=0
while [ $eNo -le $batchEntities ]
