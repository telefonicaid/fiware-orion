...
TEST(mongoUpdateContext_withOnchangeSubscriptions, Cond1_updateMatch)
{
    ...
    EXPECT_CALL(*notifierMock, sendNotifyContextRequest(MatchNcr(&expectedNcr), MatchHttpInfo(&httpInfo), "", "", "no correlator", NGSI_V1_LEGACY, attrsFilter))
            .Times(1);
...
TEST(mongoUpdateContext_withOnchangeSubscriptions, Cond1_updateMatch_noType)
{
    ...
    EXPECT_CALL(*notifierMock, sendNotifyContextRequest(MatchNcr(&expectedNcr1), MatchHttpInfo(&httpInfo), "", "", "no correlator", NGSI_V1_LEGACY, attrsFilter))
            .Times(1);
    EXPECT_CALL(*notifierMock, sendNotifyContextRequest(MatchNcr(&expectedNcr2), MatchHttpInfo(&httpInfo2), "", "", "no correlator", NGSI_V1_LEGACY, attrsFilter))
            .Times(1);
    setNotifier(notifierMock);
...
TEST(mongoUpdateContext_withOnchangeSubscriptions, Cond1_updateNoMatch)
{
    ...
    EXPECT_CALL(*notifierMock, sendNotifyContextRequest(_, MatchHttpInfo(&httpInfo), "", "", "no correlator", NGSI_V1_LEGACY, attrsFilter))
            .Times(0);
    setNotifier(notifierMock);
