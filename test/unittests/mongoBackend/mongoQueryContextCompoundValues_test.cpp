...
TEST(mongoQueryContextCompoundValuesRequest, CompoundValue1)
{
    ...
    EXPECT_EQ(orion::CompoundValueNode::Vector, RES_CER_ATTR(0, 0)->compoundValueP->valueType);
    EXPECT_EQ(orion::CompoundValueNode::String, RES_CER_ATTR(0, 0)->compoundValueP->childV[0]->valueType);
    EXPECT_EQ("22", RES_CER_ATTR(0, 0)->compoundValueP->childV[0]->stringValue);
    EXPECT_EQ(orion::CompoundValueNode::Vector, RES_CER_ATTR(0, 0)->compoundValueP->childV[1]->childV[0]->valueType);
    EXPECT_EQ("x", RES_CER_ATTR(0, 0)->compoundValueP->childV[1]->childV[0]->name);
    EXPECT_EQ(orion::CompoundValueNode::String, RES_CER_ATTR(0, 0)->compoundValueP->childV[1]->childV[0]->childV[0]->valueType);
    EXPECT_EQ("x1", RES_CER_ATTR(0, 0)->compoundValueP->childV[1]->childV[0]->childV[0]->stringValue);
    EXPECT_EQ(orion::CompoundValueNode::String, RES_CER_ATTR(0, 0)->compoundValueP->childV[1]->childV[0]->childV[1]->valueType);
    EXPECT_EQ("x2", RES_CER_ATTR(0, 0)->compoundValueP->childV[1]->childV[0]->childV[1]->stringValue);
    EXPECT_EQ(orion::CompoundValueNode::String, RES_CER_ATTR(0, 0)->compoundValueP->childV[1]->childV[1]->valueType);
    ...
    EXPECT_EQ(orion::CompoundValueNode::Vector, RES_CER_ATTR(0, 0)->compoundValueP->childV[2]->valueType);
    EXPECT_EQ(orion::CompoundValueNode::String, RES_CER_ATTR(0, 0)->compoundValueP->childV[2]->childV[0]->valueType);
    EXPECT_EQ("z1", RES_CER_ATTR(0, 0)->compoundValueP->childV[2]->childV[0]->stringValue);
    EXPECT_EQ(orion::CompoundValueNode::String, RES_CER_ATTR(0, 0)->compoundValueP->childV[2]->childV[1]->valueType);
...
TEST(mongoQueryContextCompoundValuesRequest, CompoundValue2)
{
    ...
    EXPECT_EQ(orion::CompoundValueNode::Object, RES_CER_ATTR(0, 0)->compoundValueP->valueType);
    EXPECT_EQ(orion::CompoundValueNode::Object, RES_CER_ATTR(0, 0)->compoundValueP->childV[0]->valueType);
    EXPECT_EQ("x", RES_CER_ATTR(0, 0)->compoundValueP->childV[0]->name);
    EXPECT_EQ(orion::CompoundValueNode::String, RES_CER_ATTR(0, 0)->compoundValueP->childV[0]->childV[0]->valueType);
    ...
    EXPECT_EQ(orion::CompoundValueNode::String, RES_CER_ATTR(0, 0)->compoundValueP->childV[0]->childV[1]->valueType);
    ...
    EXPECT_EQ(orion::CompoundValueNode::Vector, RES_CER_ATTR(0, 0)->compoundValueP->childV[1]->valueType);
    EXPECT_EQ("y", RES_CER_ATTR(0, 0)->compoundValueP->childV[1]->name);
    EXPECT_EQ(orion::CompoundValueNode::String, RES_CER_ATTR(0, 0)->compoundValueP->childV[1]->childV[0]->valueType);
...
TEST(mongoQueryContextCompoundValuesRequest, CompoundValue1Native)
{
    ...
    EXPECT_EQ("TA1", RES_CER_ATTR(0, 0)->type);
    EXPECT_EQ(orion::CompoundValueNode::Vector, RES_CER_ATTR(0, 0)->compoundValueP->valueType);
    EXPECT_EQ(orion::CompoundValueNode::Number, RES_CER_ATTR(0, 0)->compoundValueP->childV[0]->valueType);
    ...
    EXPECT_EQ(orion::CompoundValueNode::String, RES_CER_ATTR(0, 0)->compoundValueP->childV[1]->childV[0]->childV[1]->valueType);
    EXPECT_EQ("x2", RES_CER_ATTR(0, 0)->compoundValueP->childV[1]->childV[0]->childV[1]->stringValue);
    EXPECT_EQ(orion::CompoundValueNode::Number, RES_CER_ATTR(0, 0)->compoundValueP->childV[1]->childV[1]->valueType);
    EXPECT_EQ("y", RES_CER_ATTR(0, 0)->compoundValueP->childV[1]->childV[1]->name);
    EXPECT_EQ(3.0, RES_CER_ATTR(0, 0)->compoundValueP->childV[1]->childV[1]->numberValue);
    EXPECT_EQ(orion::CompoundValueNode::Vector, RES_CER_ATTR(0, 0)->compoundValueP->childV[2]->valueType);
    EXPECT_EQ(orion::CompoundValueNode::String, RES_CER_ATTR(0, 0)->compoundValueP->childV[2]->childV[0]->valueType);
    EXPECT_EQ("z1", RES_CER_ATTR(0, 0)->compoundValueP->childV[2]->childV[0]->stringValue);
    EXPECT_EQ(orion::CompoundValueNode::Bool, RES_CER_ATTR(0, 0)->compoundValueP->childV[2]->childV[1]->valueType);
...
TEST(mongoQueryContextCompoundValuesRequest, CompoundValue2Native)
{
    ...
    EXPECT_EQ("x1", RES_CER_ATTR(0, 0)->compoundValueP->childV[0]->childV[0]->name);
    EXPECT_EQ("a", RES_CER_ATTR(0, 0)->compoundValueP->childV[0]->childV[0]->stringValue);
    EXPECT_EQ(orion::CompoundValueNode::Bool, RES_CER_ATTR(0, 0)->compoundValueP->childV[0]->childV[1]->valueType);
    EXPECT_EQ("x2", RES_CER_ATTR(0, 0)->compoundValueP->childV[0]->childV[1]->name);
