...
{
  { "POST",   UpdateContextAvailabilitySubscription, 2, { "ngsi9",  "updateContextAvailabilitySubscription"    }, "", postUpdateContextAvailabilitySubscription },
...
TEST(postUpdateContextAvailabilitySubscription, DISABLED_notFound)
{
  ...
  const char*    outfile   = "ngsi9.updateContextAvailabilitySubscriptionResponse.subscriptionIdNotFound.valid.xml";
  std::string    out;
