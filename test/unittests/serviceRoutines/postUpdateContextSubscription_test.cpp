...
{
  { "POST",   UpdateContextSubscription,             2, { "ngsi10", "updateContextSubscription"                }, "", postUpdateContextSubscription             },
...
TEST(postUpdateContextSubscription, DISABLED_notFound)
{
  ...
  const char*    outfile   = "ngsi10.updateContextSubscriptionResponse.subscriptionNotFound.valid.xml";
  std::string    out;
