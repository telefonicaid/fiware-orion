...
*/
TEST(getContextEntityTypeAttributeContainer, DISABLED_nothingFound)
{
...
TEST(getContextEntityTypeAttributeContainer, DISABLED_somethingFound)
{
  ...
  const char*    outfile2 = "ngsi9.discoverContextAvailabilityResponse.getContextEntityTypeAttributeContainer.ok.valid.xml";
  std::string    out;
