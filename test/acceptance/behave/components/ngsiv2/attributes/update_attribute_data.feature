...
Feature: update an attribute by entity ID and attribute name if it exists using NGSI v2 API. "PUT" - /v2/entities/<entity_id>/attrs/<attr_name> plus payload
  ...
  Scenario:  try to update attributes by ID and attribute name using NGSI v2 with maximum size in payload
    ...
    When update an attribute by ID "room" and attribute name "temperature_0" if it exists
      | parameter        | value          |
      | attributes_value | random=1048392 |
      | attributes_type  | Fahrenheit     |
      | metadatas_number | 3              |
      | metadatas_name   | very_hot       |
      | metadatas_type   | alarm          |
 ...
 # ------------------------ Service path ----------------------------------------------
  ...
  Scenario:  try to update an attribute by entity ID and attribute name using NGSI v2 API with empty entity_id
    ...
    And create "1" entities with "3" attributes
      ...
      | metadatas_value  | hot         |
    And verify that receive several "Created" http code
    When update an attribute by ID "" and attribute name "speed" if it exists
      | parameter        | value |
      | attributes_value | 80    |
    Then verify that receive an "Bad Request" http code
    And verify an error response
 ...
 # --------------------- attribute name  ------------------------------------
  ...
  Scenario:  try to update an attribute by entity ID and attribute name using NGSI v2 but the attribute name does not exist
    ...
    And create "1" entities with "1" attributes
      ...
      | metadatas_value  | hot         |
    And verify that receive several "Created" http code
    When update an attribute by ID "room" and attribute name "wrwerwerw" if it exists
      | parameter        | value |
      | attributes_value | 80    |
    Then verify that receive an "Not Found" http code
    And verify an error response
  ...
  Scenario Outline:  try to update an attribute by entity id and attribute name using NGSI v2 API with invalid attribute names
    ...
    And create "1" entities with "3" attributes
      ...
      | metadatas_value  | hot         |
    And verify that receive several "Created" http code
    When update an attribute by ID "room" and attribute name "<attributes_name>" if it exists
      | parameter        | value |
      | attributes_value | 80    |
    Then verify that receive an "Bad Request" http code
    And verify an error response
 ...
 # --------------------- attribute value  ------------------------------------
  ...
  Scenario Outline:  update an attribute by entity ID and attribute name using NGSI v2 with special attribute values (compound, vector, boolean, etc) without attribute type not metadata but with attribute type in update
    ...
    And create "1" entities with "3" attributes
      ...
      | attributes_value | 45          |
    And verify that receive several "Created" http code
    When update an attribute by ID "<entity_id>" and attribute name "temperature_0" if it exists in raw mode
      | parameter        | value              |
      | attributes_value | <attributes_value> |
      | attributes_type  | "celcius"          |
    Then verify that receive an "No Content" http code
  ...
  Scenario Outline:  update an attribute by entity ID and attribute name using NGSI v2 with several attributes type, without attribute type nor metadatas previously in attribute
    Given  a definition of headers
      | parameter          | value                 |
  ...
  @attribute_type_update
  Scenario Outline:  update an attribute by entity ID and attribute name using NGSI v2 with several attributes type, with attribute type previously in attribute
    Given  a definition of headers
      | parameter          | value                 |
      | Fiware-Service     | attribute_type_update |
      | Fiware-ServicePath | /test                 |
  ...
  @attribute_type_update
  Scenario Outline:  update an attribute by entity ID and attribute name using NGSI v2 with several attributes type, with metadata previously in attribute
    Given  a definition of headers
      | parameter          | value                 |
      | Fiware-Service     | attribute_type_update |
      | Fiware-ServicePath | /test                 |
  ...
  @attribute_type_update_error_2 @BUG_1428 @skip
  ...
  @attribute_type_update_error_3 @BUG_1212 @skip
  ...
  Scenario Outline:  update an attribute by entity ID and attribute name using NGSI v2 with several attribute metadata name without attribute type nor metadatas previously in attribute
    ...
    Examples:
      ...
      | room_18   | random=50000         |

  @attribute_metadata_name_update_2 @BUG_1217 @skip
  ...
  @attribute_metadata_name_update_4 @BUG_1433 @skip
  ...
  @attribute_metadata_name_update_error_1 @BUG_1220 @skip
  ...
  @attribute_metadata_name_update_error_2 @BUG_1428 @skip
  Scenario Outline:  try to update an attribute by entity ID and attribute name using NGSI v2 with wrong attribute metadata name without attribute metadata type
    Given  a definition of headers
      | parameter          | value                                     |
      | Fiware-Service     | test_attribute_metadata_name_update_error |
  ...
  @attribute_metadata_name_update_error_3 @BUG_1428 @skip
  Scenario Outline:  try to update an attribute by entity ID and attribute name using NGSI v2 with wrong attribute metadata name with attribute metadata type
    Given  a definition of headers
      | parameter          | value                                     |
      | Fiware-Service     | test_attribute_metadata_name_update_error |
  ...
  @attribute_metadata_name_update_error_4 @BUG_1438 @skip
  ...
  @attribute_metadata_name_update_error_5 @BUG_1438 @skip
  Scenario:  try to update an attribute by entity ID and attribute name using NGSI v2 with empty attribute metadata name with attribute metadata type
    ...
    And create "1" entities with "1" attributes
      ...
      | attributes_value | 84          |
    And verify that receive several "Created" http code
    When update an attribute by ID "room_2" and attribute name "temperature" if it exists
      | parameter       | value       |
      | attributes_name | temperature |
      | metadatas_name  |             |
      | metadatas_value | 5678        |
  ...
  @attribute_metadata_value_update_1 @BUG_1216 @skip
  ...
  @attribute_metadata_value_update_2 @BUG_1216 @skip
  ...
  @attribute_metadata_value_update_error_1 @BUG_1216 @skip
  ...
  @attribute_metadata_value_update_error_2 @BUG_1428 @skip
  ...
  @attribute_metadata_value_update_error_3 @BUG_1428 @skip
