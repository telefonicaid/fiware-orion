...
Feature: update or append an attribute by entity ID in NGSI v2. "POST" - /v2/entities/<entity_id> plus payload
  ...
  Scenario:  try to update or append attributes by entity ID in NGSI v2 with unknown entity id values
    Given  a definition of headers
      | parameter          | value                        |
    ...
    And create "5" entities with "3" attributes
      ...
      | metadatas_value  | hot         |
    And verify that receive several "Created" http code
    When update or append an attribute by ID "utyuty"
      | parameter        | value       |
      | attributes_name  | temperature |
      | attributes_value | 80          |
    Then verify that receive an "Created" http code
  ...
  Scenario Outline:  try to update or append attributes by entity ID in NGSI v2 with invalid entity id values
    Given  a definition of headers
      ...
      | Fiware-ServicePath | /test                 |
      | Content-Type       | application/json      |
    When update or append an attribute by ID "<entity_id>"
      | parameter        | value       |
      | attributes_name  | temperature |
      | attributes_value | 80          |
    Then verify that receive an "Bad Request" http code
  ...
  Scenario Outline:  try to update or append attributes by entity ID in NGSI v2 with invalid attribute names
    Given  a definition of headers
      ...
      | Fiware-ServicePath | /test                            |
      | Content-Type       | application/json                 |
    When update or append an attribute by ID "room" in raw mode
      | parameter        | value             |
      | attributes_name  | <attributes_name> |
  ...
  Scenario Outline:  update an attribute by entity ID in NGSI v2 with special attribute values (compound, vector, boolean, etc) and without attribute type nor metadatas
    ...
    And create "1" entities with "1" attributes
      ...
      | attributes_value | 45          |
    And verify that receive several "Created" http code
    When update or append an attribute by ID "<entity_id>" in raw mode
      | parameter        | value              |
      | attributes_name  | "temperature"      |
      | attributes_value | <attributes_value> |
    Then verify that receive an "Created" http code
  ...
  Scenario Outline:  try to update or append an attribute by entity ID in NGSI v2 with forbidden attributes type
    ...
    And create "1" entities with "1" attributes
      ...
      | attributes_type  | celcius     |
    And verify that receive several "Created" http code
    When update or append an attribute by ID "<entities_id>"
      | parameter       | value             |
      | attributes_name | temperature       |
      | attributes_type | <attributes_type> |
  ...
  @attribute_metadata_name_append
  ...
  Scenario Outline:  try to update or append an attribute by entity ID in NGSI v2 with wrong attribute metadata name without attribute metadata type
    Given  a definition of headers
      ...
      | Fiware-ServicePath | /test                                     |
      | Content-Type       | application/json                          |
    When update or append an attribute by ID "room2"
      | parameter       | value                  |
      | attributes_name | temperature            |
      | metadatas_name  | <attributes_meta_name> |
      | metadatas_value | 5678                   |
  ...
  @attribute_metadata_value_update
  ...
  @attribute_metadata_value_append
  ...
  @attribute_metadata_value_update_special
  ...
  @attribute_metadata_type_update
  ...
  @attribute_metadata_type_append
