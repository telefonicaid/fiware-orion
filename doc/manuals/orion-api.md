...
| `lastNotificationDuration`                                                                                                                                                                                                                                                                     | Only on retrieval | number  | Not editable, only present in GET operations. Duration of the last notification attempt in milliseconds. Not included in MQTT and KAFKA subscriptions.                                           |
| `accumulatedNotificationDuration`                                                                                                                                                                                                                                                              | Only on retrieval | number  | Not editable, only present in GET operations. Sum of durations of all notification attempts in milliseconds. Not included in MQTT and KAFKA subscriptions.                                      |
