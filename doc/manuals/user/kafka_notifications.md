...
`Payload`: (message body): This is the main content of the message that Orion publishes to Kafka. It corresponds to the notification payload or the content generated by a custom notification

Check more information about custom notifications in [the corresponding section of the Orion API document](../orion-api.md#custom-notifications).
