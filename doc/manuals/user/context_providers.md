...
-   You should include entity type in the query/update in order ContextBroker being able to
    forward to Context Providers. Otherwise you could have problems as the one described in this
