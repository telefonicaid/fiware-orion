...
And/Or: run the Unit Tests (there are no specific Unit Tests for the NGSi-LD part, only older orion stuff), how to do 
it is described [here](installation-guide-for-unit-tests.md).
