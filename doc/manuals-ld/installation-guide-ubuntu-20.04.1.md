...
To install version 1.21.1 of the mongo C driver:
```
cd /opt
sudo mkdir mongoc
...
The version 4.4 is recommended for Ubuntu 20.04, as older versions of mongodb don't seem to be supported in Ubuntu 20.04 (there are no
installation instructions in the mongodb website for Ubuntu 20.04 and mongodb 4.0, nor 4.2 - just 4.4).
...
For more details on the MongoDB installation process, or if something goes wrong,
please refer to the [MongoDB documentation](https://docs.mongodb.com/manual/tutorial/install-mongodb-on-ubuntu/)
