...
static void addCompoundNode(orion::CompoundValueNode* cvP, const BSONElement& e)
{
  ...
  orion::CompoundValueNode* child = new orion::CompoundValueNode("TEST", orion::CompoundValueNode::Struct);
        ...
        for (unsigned int ix = 0; ix < queryAttrV.size(); ++ix) {
            ...
            if (includedAttribute(ca, &attrL)) {
                ...
                if (queryAttr.getField(ENT_ATTRS_VALUE).type() == String) {
                    ...
                    caP->compoundValueP = new orion::CompoundValueNode("xxx", orion::CompoundValueNode::Struct);
                    ...
                    caP = new ContextAttribute(ca.name, ca.type);
                    caP->compoundValueP = new orion::CompoundValueNode("xxx", orion::CompoundValueNode::Vector);
