#ifndef SRC_LIB_MONGOBACKEND_MONGOLDREGISTRATIONGET_H_
#define SRC_LIB_MONGOBACKEND_MONGOLDREGISTRATIONGET_H_
...
#endif  // SRC_LIB_MONGOBACKEND_MONGOLDREGISTRATIONGET_H_
