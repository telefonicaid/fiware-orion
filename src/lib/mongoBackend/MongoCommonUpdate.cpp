...
)
{
  ...
  *attributeNotExistingList            = "[ ";
  ...
  ContextElementResponse*  notifyCerP = new ContextElementResponse(r, emptyAttrL/*, true*/);
  ...
  *attributeAlreadyExistsList += " ]";
  ...
  if (useFindAndModify)
  {
    ...
    if (success)
    {
      ...
      notifyCerP = new ContextElementResponse(getObjectFieldF(reply, "value"), emptyAttrL/*, true*/);
    }
  }
  else
  {
