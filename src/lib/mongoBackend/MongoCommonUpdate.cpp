...
)
{
   ...
   *
   * - the item isPattern field is "true" AND
   * - the item isTypePattern field is false OR doesn't exist AND
   * - the item type is empty string OR doesn't exist OR is equal to the target type (entityType) AND
   * - the item id matches the target id (entityId)
   *
   * Example of query block generated by this function:
   *
   * {
...
)
{
   ...
   * Given a subscription document, for each item within the entities array field, the condition is true if:
   *
   * - the item isPattern field is "false" AND
   * - the item isTypePattern field is true AND
   * - the item id field is equal to target id (entityId) AND
   * - the item type matches the target entity type (entityType)
   *
   * Example of query block generated by this function:
   *
   * {
...
)
{
   ...
   * - the item isPattern field is "true" AND
   * - the item isTypePattern field is true AND
   * - the item id matches the target entity id (entityId) AND
   * - the item type matches the target entity type (entityType)
   *
   * Example of query block generated by this function:
   *
