...
* uncrParseVector - 
*/
extern XmlNode uncrParseVector[];
...
* uncrInit - 
*/
extern void uncrInit(ParseData* reqData);
...
* uncrRelease - 
*/
extern void uncrRelease(ParseData* reqData);
...
* uncrCheck - 
*/
extern std::string uncrCheck(ParseData* reqData, ConnectionInfo* ciP);
