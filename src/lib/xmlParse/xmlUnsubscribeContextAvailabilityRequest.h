#ifndef SRC_LIB_XMLPARSE_XMLUNSUBSCRIBECONTEXTAVAILABILITYREQUEST_H_
#define SRC_LIB_XMLPARSE_XMLUNSUBSCRIBECONTEXTAVAILABILITYREQUEST_H_
...
#endif  // SRC_LIB_XMLPARSE_XMLUNSUBSCRIBECONTEXTAVAILABILITYREQUEST_H_
