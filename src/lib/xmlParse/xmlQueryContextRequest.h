...
* qcrInit - 
*/
extern void qcrInit(ParseData* reqData);
...
* qcrRelease - 
*/
extern void qcrRelease(ParseData* reqData);
...
* qcrCheck - 
*/
extern std::string qcrCheck(ParseData* reqData, ConnectionInfo* ciP);
