#ifndef SRC_LIB_XMLPARSE_XMLREGISTERCONTEXTREQUEST_H_
#define SRC_LIB_XMLPARSE_XMLREGISTERCONTEXTREQUEST_H_
...
#endif  // SRC_LIB_XMLPARSE_XMLREGISTERCONTEXTREQUEST_H_
