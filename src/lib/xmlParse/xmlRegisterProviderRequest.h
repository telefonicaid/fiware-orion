...
* rprInit - 
*/
extern void rprInit(ParseData* reqData);
...
* rprRelease - 
*/
extern void rprRelease(ParseData* reqData);
...
* rprCheck - 
*/
extern std::string rprCheck(ParseData* reqData, ConnectionInfo* ciP);
