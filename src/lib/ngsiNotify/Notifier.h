...
public:
    ...
    virtual void sendNotifyContextRequest(NotifyContextRequest* ncr, std::string url);
    virtual void sendNotifyContextAvailabilityRequest(NotifyContextAvailabilityRequest* ncr, std::string url);
