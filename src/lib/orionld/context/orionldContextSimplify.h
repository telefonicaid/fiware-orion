#ifndef SRC_LIB_ORIONLD_CONTEXT_ORIONLDCONTEXTSIMPLIFY_H_
#define SRC_LIB_ORIONLD_CONTEXT_ORIONLDCONTEXTSIMPLIFY_H_
...
//
extern KjNode* orionldContextSimplify(KjNode* contextTreeP, int* itemsInArrayP);

#endif  // SRC_LIB_ORIONLD_CONTEXT_ORIONLDCONTEXTSIMPLIFY_H_
