...
//
extern OrionldContext* orionldContextFromObject(char* url, OrionldContextOrigin origin, char* id, bool toBeCloned, KjNode* contextObjectP, OrionldProblemDetails* pdP);
