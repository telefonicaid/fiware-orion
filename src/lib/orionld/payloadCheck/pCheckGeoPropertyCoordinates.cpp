...
#include "orionld/payloadCheck/pCheckGeoPropertyCoordinates.h"         // Own interface
...
bool pCheckGeoPropertyCoordinates(KjNode* coordinatesP, OrionldGeoJsonType geoType)
{
  ...
  case GeoJsonLineString:       return pCheckGeoLineStringCoordinates(coordinatesP);
  case GeoJsonMultiPoint:       return pCheckGeoMultiPointCoordinates(coordinatesP);
  case GeoJsonMultiPolygon:     return pCheckGeoMultiPolygonCoordinates(coordinatesP);
  case GeoJsonMultiLineString:  return pCheckGeoMultiLineStringCoordinates(coordinatesP);
