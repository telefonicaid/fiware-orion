...
#include "orionld/mongoBackend/mongoAttributeExists.h"      // Own Interface
...
//
bool mongoAttributeExists(const char* entityId, const char* attributeName, const char* tenant)
{
  BSONObjBuilder bob;
