#ifndef SRC_LIB_ORIONLD_DBMODEL_DBMODELFROMAPIENTITY_H_
#define SRC_LIB_ORIONLD_DBMODEL_DBMODELFROMAPIENTITY_H_
...
#endif  // SRC_LIB_ORIONLD_DBMODEL_DBMODELFROMAPIENTITY_H_
