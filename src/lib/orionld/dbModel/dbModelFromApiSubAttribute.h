#ifndef SRC_LIB_ORIONLD_DBMODEL_DBMODELFROMAPISUBATTRIBUTE_H_
#define SRC_LIB_ORIONLD_DBMODEL_DBMODELFROMAPISUBATTRIBUTE_H_
...
#endif  // SRC_LIB_ORIONLD_DBMODEL_DBMODELFROMAPISUBATTRIBUTE_H_
