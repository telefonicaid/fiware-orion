...
*/
HttpStatusCode mapPutIndividualContextEntityAttributes(std::string entityId, UpdateContextElementRequest* ucerP, UpdateContextElementResponse* response, ConnectionInfo* ciP)
{
  HttpStatusCode          ms;
