...
# o apiTypesV2/GeoFilter.cpp                                                       (haderding/remove_ngsiv1_indent: 12 lines)
# o apiTypesV2/GeoFilter.h                                                         (haderding/remove_ngsiv1_indent: 5 lines)
...
# o unittests/ngsi/GeoFilter_test.cpp                                            (haderding/remove_ngsiv1_indent: 1 render(), 4 check())
