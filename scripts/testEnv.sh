...
export BROKER_USER BROKER_PORT BROKER_PORT_AUX LISTENER_PORT LISTENER_PORT_V6 BROKER_LOG_DIR BROKER_PID_FILE BROKER_PID_FILE_AUX BROKER_DATABASE_HOST BROKER_DATABASE_NAME BROKER_DATABASE_AUX_NAME BROKER_DATABASE_USER BROKER_DATABASE_PASSWORD CM_PORT
