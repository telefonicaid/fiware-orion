...
# LISTENER_PORT_V6 - the port/socket where listening application for some ip v6 test cases listens for connections
if [ -z "${LISTENER_PORT_V6}" ]; then
    LISTENER_PORT_V6=9977
fi
...
export BROKER_USER BROKER_PORT BROKER_PORT_AUX LISTENER_PORT LISTENER_PORT_V6 BROKER_LOG_DIR BROKER_PID_FILE BROKER_PID_FILE_AUX BROKER_DATABASE_HOST BROKER_DATABASE_NAME BROKER_DATABASE_AUX_NAME BROKER_DATABASE_USER BROKER_DATABASE_PASSWORD CM_PORT MAXIMUM_WAIT
