...
def ignore(root, file):
    ...
    if 'docker' in root and file in ['Dockerfile', 'Dockerfile-deps', 'Dockerfile-debian', 'docker-compose.yml']:
        return True
    ...
    files_names = ['.dockerignore', '.gitignore', '.valgrindrc', '.valgrindSuppressions', 'LICENSE',
