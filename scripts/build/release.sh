...
#
sed "s/$currentVersion/$NEW_VERSION/" test/functionalTest/cases/version_via_rest.test > /tmp/version_via_rest.test
sed "s/$currentVersion/$NEW_VERSION/" test/functionalTest/cases/version.test          > /tmp/version.test
sed "s/$currentVersion/$NEW_VERSION/" src/app/contextBroker/version.h        > /tmp/version.h

mv /tmp/version_via_rest.test  test/functionalTest/cases/version_via_rest.test
mv /tmp/version.test           test/functionalTest/cases/version.test
...
then
    ...
    git add test/functionalTest/cases/version.test
    git add test/functionalTest/cases/version_via_rest.test
