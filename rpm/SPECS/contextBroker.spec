...
EOMSG
chmod 644 /etc/cron.d/cron-logrotate-contextBroker-size
chmod 644 /etc/logrotate.d/logrotate-contextBroker-daily
chmod 644 /etc/prelink.conf.d/contextBroker.conf
chmod 644 /etc/sysconfig/contextBroker
chmod 644 /etc/sysconfig/logrotate-contextBroker-size
chmod 644 /etc/tmpfiles.d/contextBroker.conf
